...
type CanonicalStateChainOutput struct {
	OutputRoot [32]byte
	Timestamp  uint64
}
...
//
// Solidity: function getL2Output(uint256 _index) view returns((bytes32,uint64))
func (_CanonicalStateChain *CanonicalStateChainCaller) GetL2Output(opts *bind.CallOpts, _index *big.Int) (CanonicalStateChainOutput, error) {
	var out []interface{}
	err := _CanonicalStateChain.contract.Call(opts, &out, "getL2Output", _index)

	if err != nil {
		return *new(CanonicalStateChainOutput), err
	}

	out0 := *abi.ConvertType(out[0], new(CanonicalStateChainOutput)).(*CanonicalStateChainOutput)
...
//
// Solidity: function getL2Output(uint256 _index) view returns((bytes32,uint64))
func (_CanonicalStateChain *CanonicalStateChainSession) GetL2Output(_index *big.Int) (CanonicalStateChainOutput, error) {
	return _CanonicalStateChain.Contract.GetL2Output(&_CanonicalStateChain.CallOpts, _index)
}

// GetL2Output is a free data retrieval call binding the contract method 0xa25ae557.
//
// Solidity: function getL2Output(uint256 _index) view returns((bytes32,uint64))
func (_CanonicalStateChain *CanonicalStateChainCallerSession) GetL2Output(_index *big.Int) (CanonicalStateChainOutput, error) {
	return _CanonicalStateChain.Contract.GetL2Output(&_CanonicalStateChain.CallOpts, _index)
}
...
//
// Solidity: function startingTimestamp() view returns(uint64)
func (_CanonicalStateChain *CanonicalStateChainCaller) StartingTimestamp(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _CanonicalStateChain.contract.Call(opts, &out, "startingTimestamp")
...
//
// Solidity: function startingTimestamp() view returns(uint64)
func (_CanonicalStateChain *CanonicalStateChainSession) StartingTimestamp() (uint64, error) {
	return _CanonicalStateChain.Contract.StartingTimestamp(&_CanonicalStateChain.CallOpts)
}

// StartingTimestamp is a free data retrieval call binding the contract method 0x88786272.
//
// Solidity: function startingTimestamp() view returns(uint64)
func (_CanonicalStateChain *CanonicalStateChainCallerSession) StartingTimestamp() (uint64, error) {
	return _CanonicalStateChain.Contract.StartingTimestamp(&_CanonicalStateChain.CallOpts)
}
...
// ResetHead is a paid mutator transaction binding the contract method 0xc6076c0d.
//
// Solidity: function resetHead() returns()
func (_CanonicalStateChain *CanonicalStateChainTransactor) ResetHead(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CanonicalStateChain.contract.Transact(opts, "resetHead")
}

// ResetHead is a paid mutator transaction binding the contract method 0xc6076c0d.
//
// Solidity: function resetHead() returns()
func (_CanonicalStateChain *CanonicalStateChainSession) ResetHead() (*types.Transaction, error) {
	return _CanonicalStateChain.Contract.ResetHead(&_CanonicalStateChain.TransactOpts)
}

// ResetHead is a paid mutator transaction binding the contract method 0xc6076c0d.
//
// Solidity: function resetHead() returns()
func (_CanonicalStateChain *CanonicalStateChainTransactorSession) ResetHead() (*types.Transaction, error) {
	return _CanonicalStateChain.Contract.ResetHead(&_CanonicalStateChain.TransactOpts)
}
...
type CanonicalStateChainOutputProposedIterator struct {
	Event *CanonicalStateChainOutputProposed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CanonicalStateChainOutputProposedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CanonicalStateChainOutputProposed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CanonicalStateChainOutputProposedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CanonicalStateChainOutputProposedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// CanonicalStateChainOutputProposed represents a OutputProposed event raised by the CanonicalStateChain contract.
type CanonicalStateChainOutputProposed struct {
	OutputRoot    [32]byte
...
func (_CanonicalStateChain *CanonicalStateChainFilterer) FilterOutputProposed(opts *bind.FilterOpts, outputRoot [][32]byte, l2OutputIndex []*big.Int, l2BlockNumber []*big.Int) (*CanonicalStateChainOutputProposedIterator, error) {
	...
	logs, sub, err := _CanonicalStateChain.contract.FilterLogs(opts, "OutputProposed", outputRootRule, l2OutputIndexRule, l2BlockNumberRule)
	if err != nil {
		return nil, err
	}
	return &CanonicalStateChainOutputProposedIterator{contract: _CanonicalStateChain.contract, event: "OutputProposed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event OutputProposed(bytes32 indexed outputRoot, uint256 indexed l2OutputIndex, uint256 indexed l2BlockNumber, uint256 l1Timestamp)
func (_CanonicalStateChain *CanonicalStateChainFilterer) WatchOutputProposed(opts *bind.WatchOpts, sink chan<- *CanonicalStateChainOutputProposed, outputRoot [][32]byte, l2OutputIndex []*big.Int, l2BlockNumber []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _CanonicalStateChain.contract.WatchLogs(opts, "OutputProposed", outputRootRule, l2OutputIndexRule, l2BlockNumberRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CanonicalStateChainOutputProposed)
				if err := _CanonicalStateChain.contract.UnpackLog(event, "OutputProposed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OutputProposed(bytes32 indexed outputRoot, uint256 indexed l2OutputIndex, uint256 indexed l2BlockNumber, uint256 l1Timestamp)
func (_CanonicalStateChain *CanonicalStateChainFilterer) ParseOutputProposed(log types.Log) (*CanonicalStateChainOutputProposed, error) {
	event := new(CanonicalStateChainOutputProposed)
	if err := _CanonicalStateChain.contract.UnpackLog(event, "OutputProposed", log); err != nil {
		return nil, err
	}

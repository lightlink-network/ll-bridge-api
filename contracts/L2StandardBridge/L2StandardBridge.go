...
//
// Solidity: function initialize(address _otherBridge, address _legacyERC20ETH) returns()
func (_L2StandardBridge *L2StandardBridgeTransactor) Initialize(opts *bind.TransactOpts, _otherBridge common.Address, _legacyERC20ETH common.Address) (*types.Transaction, error) {
	return _L2StandardBridge.contract.Transact(opts, "initialize", _otherBridge, _legacyERC20ETH)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _otherBridge, address _legacyERC20ETH) returns()
func (_L2StandardBridge *L2StandardBridgeSession) Initialize(_otherBridge common.Address, _legacyERC20ETH common.Address) (*types.Transaction, error) {
	return _L2StandardBridge.Contract.Initialize(&_L2StandardBridge.TransactOpts, _otherBridge, _legacyERC20ETH)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _otherBridge, address _legacyERC20ETH) returns()
func (_L2StandardBridge *L2StandardBridgeTransactorSession) Initialize(_otherBridge common.Address, _legacyERC20ETH common.Address) (*types.Transaction, error) {
	return _L2StandardBridge.Contract.Initialize(&_L2StandardBridge.TransactOpts, _otherBridge, _legacyERC20ETH)
}
